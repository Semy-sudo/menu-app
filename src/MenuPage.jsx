...
const menuData = {
  ...
  칵테일: [
    { name: "진토닉", price: "13,900", description: "시트러스 향 가득, 가장 클래식한 칵테일" },
    { name: "핸드릭스 진토닉", price: "17,900", description: "오이와 장미 향이 어우러진 고급 진토닉" },
    { name: "x토닉", price: "12,900", description: "진하고 깊은 맛, 독특한 토닉의 매력" },
    { name: "갓파더", price: "14,900", description: "위스키와 아마레토의 진한 한 방울" },
    { name: "갓마더", price: "13,900", description: "보드카와 아마레토의 부드러운 달콤함" },
